...
def create_calendar():
    ...
    for treballador in treballadors:
        try:
            ...
            calendari = Calendari(any=int(today.year),vacances=22,vacances_dies=0,perm_precep=0,perm_precep_dies=0,perm_no_precep=0,perm_no_precep_dies=0,asum_p=6,asum_p_dies=0,treballador=treballador)
            calendari.save()
            count = count+1;
